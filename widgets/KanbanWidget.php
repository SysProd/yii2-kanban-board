...
namespace SysProd\KanbanBoard\widgets;

use SysProd\KanbanBoard\KanbanBoardAsset;
...
/**
 * Class KanbanWidget
 * @package SysProd\KanbanBoard\widgets
 *
...
class KanbanWidget extends Widget
{
    ...
    private function registerTranslations()
    {
        \Yii::$app->i18n->translations[$this->defaultTranslationCategory] = [
            ...
            'basePath' => '@vendor/SysProd/KanbanBoard/widgets/messages',
        ];
    }
...
//        $directoryAsset = \Yii::$app->assetManager->getPublishedUrl('@vendor/SysProd/KanbanBoard/assets');
